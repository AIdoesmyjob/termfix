...
import (
	...
	"github.com/AIdoesmyjob/termfix/internal/app"
	"github.com/AIdoesmyjob/termfix/internal/config"
	"github.com/AIdoesmyjob/termfix/internal/llm/agent"
	...
	"github.com/AIdoesmyjob/termfix/internal/tui/components/chat"
	"github.com/AIdoesmyjob/termfix/internal/tui/components/core"
	"github.com/AIdoesmyjob/termfix/internal/tui/components/dialog"
	"github.com/AIdoesmyjob/termfix/internal/tui/layout"
	"github.com/AIdoesmyjob/termfix/internal/tui/page"
...
func New(app *app.App) tea.Model {
	...
	model.RegisterCommand(dialog.Command{
		...
		Description: "Create/Update the termfix.md memory file",
		Handler: func(cmd dialog.Command) tea.Cmd {
			prompt := `Please analyze this system environment and create a termfix.md file containing:
1. Common diagnostic commands for this system
2. Key system services and their status
3. Important log file locations
4. Network configuration summary

The file you create will be used as context for future troubleshooting sessions. Make it about 20 lines long.
If there's already a termfix.md, improve it.`
			return tea.Batch(
	...
	model.RegisterCommand(dialog.Command{
		...
		Description: "Collect system facts and diagnose an issue (/diagnose <error>)",
		Handler: func(cmd dialog.Command) tea.Cmd {
			return tea.Batch(
				util.CmdHandler(chat.SendMsg{
					Text: "/diagnose general system health check",
				}),
			)
		},
	})
