...
import (
	...
	"github.com/AIdoesmyjob/termfix/internal/db"
	"github.com/AIdoesmyjob/termfix/internal/format"
	...
	"github.com/AIdoesmyjob/termfix/internal/tui"
...
var rootCmd = &cobra.Command{
	Use:   "termfix",
	Short: "Offline system troubleshooting assistant",
	Long: `termfix is an offline terminal-based troubleshooting assistant powered by a local LLM.
It provides an interactive chat interface for diagnosing system issues, analyzing logs,
and investigating problems directly from the terminal.`,
	Example: `
  ...
  termfix -d -c /path/to/project

  # Print version
  termfix -v

  # Run a single non-interactive prompt
  termfix -p "check disk usage"

  # Run a single non-interactive prompt with JSON output format
  termfix -p "check disk usage" -f json
  `,
